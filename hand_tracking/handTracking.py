'''
Script to perform hand tracking. Inputs video through the webcam, and tracks
the hand. Computes the fingertip positions. 
'''

#TODO
1. estimate and draw fingertips
2. calculate diff between fingers and center. calculate ratio
...
def im2double(im):
    ...
    return im.astype(np.float) / info.max # Divi
...
while(1):
    ...
    subFrame = abs(gray_img - background)+25;
  ...
  #   median = cv2.medianBlur(dilation2,5)
    ...
    # print 'These are the finger tip coordinates: '
    # print fingers
    #TODO: Modify the function to take in images, and then we can 
    #Store the coordinates here into files like before, for each image
    #Write another script to 
